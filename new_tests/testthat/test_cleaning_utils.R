...
# Reformatting date
test_that(
  "reformat_data converts a column to datetype.",
  {
...
# Fill NAs
test_that(
  "reformat_data fill's NULL values with 0 in specified columns.",
  {
    test_df <- data.frame(
      row1 = c(1, 2, NA, 3, NA),
      row2 = c("a", "b", NA, "c", "d"),
...
# Year from Date
test_that(
  "reformat_date can derive the year from a date column.",
  {
