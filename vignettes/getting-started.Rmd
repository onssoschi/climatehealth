...
project. It covers six climate-health topic areas:
...
- **Methodology documents** for each SOSCHI topic are linked from the
  [package README](https://github.com/onssoschi/climatehealth#soschi-topics).
- **Report issues** at <https://github.com/onssoschi/climatehealth/issues>.
